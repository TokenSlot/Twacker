<?php
    ...
    $twack_id = $_GET['twack_id'];
    $twacks = "SELECT twack_tbl.*,user_tbl.id,user_tbl.username user FROM twack_tbl INNER JOIN user_tbl ON twack_tbl.author=user_tbl.id WHERE twack_id=$twack_id";
            ...
            <div class="card-body pt-3 pr-3 pl-3 pb-0">
                ...
                <ul class="list-inline mb-2 border-top pt-1">
                    ...
                    <!-- <li class="list-inline-item border-left pl-3">
                        <a class="btn btn-link m-0 p-0 text-secondary twack-deco"><i class="fas fa-comment"></i> comment </a>
                    </li> -->
                    <?php if ($row['author'] == $_SESSION['id']): ?>
                    <div class="d-none d-md-inline">
                        <li class="list-inline-item border-left pl-3">
                            <a onclick="show_edit_modal('<?=$row['twack_id']?>')" class="btn btn-link m-0 p-0 text-secondary twack-deco" data-toggle="modal" data-target="#editTwackModal">
                        ...
                        <li class="list-inline-item">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a onclick="show_edit_modal('<?=$row['twack_id']?>')" class="dropdown-item text-secondary twack-deco" data-toggle="modal" data-target="#editTwackModal">edit</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input name="twack-edit" class="btn btn-primary btn-block" id="twackEditbtn" type="button" value="EDIT">
                </div>
            </div>
        </div>
    </div>
